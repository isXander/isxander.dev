...
import MarkdownLayout from "@/app/ui/MarkdownLayout"
import YoutubeEmbed from "@/app/ui/YoutubeEmbed"
import PhotoGrid from "@/app/ui/photography/PhotoGrid"
import { photos } from "@/app/lib/photography"
import evergreenHudImage from "./evergreenhud.webp"
...
I create mods for Minecraft using Java and Kotlin. I have ammased over 200 million downloads and am gunning for more!
I publish my mods on 2 sites, [Modrinth](https://modrinth.com/user/isxander), [Curseforge](https://www.curseforge.com/members/xanderisdev), and the source code is available on [Github](https://github.com/isXander)!

Modding for Minecraft is not as easy as one might think. I use the [Fabric toolchain](https://fabricmc.net) to mod, which includes regular use of [Mixin](https://github.com/Spongepowered/Mixin), a bytecode manipulation library. In most cases with Fabric, you need to modify the Minecraft source code directly to achieve your goal.
...
<PhotoGrid photos={photos.sort(() => (Math.random() > .5) ? 1 : -1).slice(0, 3)} />
...
<Image src={evergreenHudImage} alt="Early version of EvergreenHUD" />
